...
class Comment(models.Model):
    comment_user = models.ForeignKey(UserNew, on_delete=models.CASCADE)
...
class Block_User(models.Model):
    blocking_user = models.ForeignKey(UserNew, on_delete=models.CASCADE, related_name="blog_user_blocker")
    blocked_user = models.ForeignKey(UserNew, on_delete=models.CASCADE, related_name="blog_user_blocked")
